...
void ChangeScene::SelectFromGameUpDate(bool& isChangeScene, Vec2 CPos[], int selectNum) {
...
#pragma region"シーンチェンジで開始"
		...
		if (isChangeScene && !isChangeSelect_) {
...
#pragma region"ゲーム本編での処理（ステージからゲーム画面）"
...
void  ChangeScene::SelectFromGameDraw(int GH, unsigned int DoorColor) {
	switch (Scene::sceneNum_) {
		//====================================================================================
	case TITLE://							   タイトル画面
		//====================================================================================
